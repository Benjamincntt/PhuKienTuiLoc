...
const quickLinks = [
  ...
  { icon: Percent, label: "Mã giảm giá" },
  { icon: Sparkles, label: "Tích điểm" },
  { icon: Gift, label: "Quà tặng" },
  { icon: Heart, label: "Sức khỏe" },
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 text-xs md:text-sm">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            {quickLinks.map(({ icon: Icon, label }) => (
              <span key={label} className="flex items-center gap-1 opacity-90">
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-center gap-2 py-3 sm:gap-4 sm:py-4">
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-2">
            ...
            <Button variant="secondary" size="sm" className="gap-2 rounded-full sm:h-10 sm:px-4">
